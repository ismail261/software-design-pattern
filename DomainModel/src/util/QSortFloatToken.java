...
QSortFloatToken qsst=new QSortFloatToken(2);// Second Column
...
public QSortFloatToken(int new_field)
...
//-------------------------------------------------------------
...

  {
    ...
    f2=Float.valueOf(s2).floatValue();
