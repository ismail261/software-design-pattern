...
public class AggregationOkAction extends OkAction {
   ...
   public void actionPerformed(ActionEvent e) {
      ...
      partClass = partClass + "(" + multiplicity + ")";
      aggregationName = "Aggregation" + "(" + aggregationName + ")";
      
      finalRowContent = wholeClass + "&" + aggregationName + "&" + partClass;
      actionStatus = "Ok";
      
//      Gui.setRelationTableValue(wholeClass, row, 0);
//      Gui.setRelationTableValue(aggregationName, row, 1);
//      Gui.setRelationTableValue(partClass, row, 2);
