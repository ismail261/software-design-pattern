...
public class Gui extends java.awt.event.WindowAdapter implements java.awt.event.
   WindowListener, CaretListener, MouseListener {
	int mE=0;
	private JTable tableClassAtt=null;
	   private JTable tableClassRel=null;
   public HashMap<String, String> selectedMap = new HashMap<>();
   private JList list;
   private JList finalList;
   private static Gui instance;
   private static String startEndPosition = "";
   ORDLayout ordLayout;
   ORDCanvas ordCanvas;
   ...
   private JScrollPane FinalListPane=null;
   private JButton AddButton=null;
   private JButton unHighlightAllButton=null;
   ...
   private JLabel finalListLabel=null;
   ...
   private ClassDialog classDialog=new ClassDialog(getJFrame(), 0, 0);
   private AttributeDialog attributeDialog=new AttributeDialog(getJFrame());
   private AggregationDialog aggregationDialog=new AggregationDialog(getJFrame(),0,0);
   private AssociationDialog associationDialog=new AssociationDialog(getJFrame(),0,0);
   private InheritanceDialog inheritanceDialog=new InheritanceDialog(getJFrame(),0,0);
   ...
   public void addParseListener(ActionListener al) {
	      getParseButton().addActionListener(al);
	   }
   
   public void addUnHighlightAllListener(ActionListener al) {
	      getUnHighlightAllButton().addActionListener(al);
	   }
...
//	}
   ...
   private JPanel getJContentPane() {
	      if (jContentPane == null) {
	         ...
	         gridBagConstraints17.insets=new Insets(-155, 15, 22, 37);
	         ...
	         GridBagConstraints gridBagConstraints9a=new GridBagConstraints();
	         gridBagConstraints9a.fill=GridBagConstraints.BOTH;
	         gridBagConstraints9a.gridheight=3;
	         gridBagConstraints9a.gridwidth=2;
	         gridBagConstraints9a.gridx=1;
	         gridBagConstraints9a.gridy=9;
	         gridBagConstraints9a.ipadx=222;
	         gridBagConstraints9a.ipady=100;
	         gridBagConstraints9a.weightx=1;
	         gridBagConstraints9a.weighty=1;
	         gridBagConstraints9a.insets=new Insets(-63, 15, 20, 7);
	         GridBagConstraints gridBagConstraints9b=new GridBagConstraints();
	         gridBagConstraints9b.fill=GridBagConstraints.BOTH;
	         gridBagConstraints9b.gridheight=3;
	         gridBagConstraints9b.gridwidth=2;
	         gridBagConstraints9b.gridx=1;
	         gridBagConstraints9b.gridy=14;
	         gridBagConstraints9b.ipadx=222;
	         gridBagConstraints9b.ipady=50;
	         gridBagConstraints9b.weightx=1;
	         gridBagConstraints9b.weighty=1;
	         gridBagConstraints9b.insets=new Insets(-100, 15, 20, 7);
	         ...
	         gridBagConstraints1.ipady=151;
	         gridBagConstraints1.weightx=1.0;
	         gridBagConstraints1.weighty=1.0;
	         gridBagConstraints1.insets=new Insets(30, 15, 7, 7);
	         GridBagConstraints gridBagConstraints24=new GridBagConstraints();
	         gridBagConstraints24.insets=new Insets(1, 7, 5, 19);
	         gridBagConstraints24.gridy=2;
	         gridBagConstraints24.ipadx=25;
	         gridBagConstraints24.ipady=5;
	         gridBagConstraints24.gridx=3;
	         GridBagConstraints gridBagConstraints25=new GridBagConstraints();
	         gridBagConstraints25.insets=new Insets(1, 7, 5, 19);
	         ...
	         jLabel.setText("<html>1)<font color='red'> Noun/noun phrase</font></html>");
	         jp.add(jLabel);
	         
	         jp.add(new JLabel("<html>2)<font color='red'> X </font><font color='#408080'>of </font><font color='red'>Y </font><font color='#408080'>expression</font></html>"));
	         
	         jLabel = new JLabel();
	         jLabel.setText("<html>3)<font color='blue'> Transitive verb</font></html>");
	         jp.add(jLabel);
	         
	         jLabel = new JLabel();
	         jLabel.setText("<html>4)<font color='#D56A00'> Adjective</font></html>");
	         jp.add(jLabel);
	         
	         jLabel = new JLabel();
	         jLabel.setText("<html>5)<font color='#008000'> Numeric/enumeration</font></html>");
	         jp.add(jLabel);
	         
	         jp.add(new JLabel("<html>6)<font color='#8B4513'> Possession expression</font></html>"));
	         jp.add(new JLabel("<html>7)<font color='#C71585'> Part of expression</font></html>"));
	         jp.add(new JLabel("<html>8)<font color='#9400D3'> Containment expression</font></html>"));
	         jp.add(new JLabel("<html>9)<font color='red'> X </font><font color='#008080'>is </font><font color='red'>Y </font><font color='#008080'>expression</font></html>"));
	         jContentPane.add(jp, gridBagConstraints2);
	         jContentPane.add(getParseButton(), gridBagConstraints24);
	         jContentPane.add(getUnHighlightAllButton(), gridBagConstraints25);
	         //jContentPane.add(getListScrollPane(), gridBagConstraints9);
	         jContentPane.add(createClassAttributeTable(), gridBagConstraints9a);
	         jContentPane.add(createClassRelationshipTable(), gridBagConstraints9b);
   ...
   /**
    * This method initializes Class-Attribute Table
    *
    * @return javax.swing.JTable
    */
   private JPanel createClassAttributeTable() {
       ...
       tableClassAtt = new JTable(model);
       tableClassAtt.getTableHeader().setFont(new Font("Arial", Font.ITALIC + Font.BOLD , 12));
       tableClassAtt.getTableHeader().setReorderingAllowed(false);
       tableClassAtt.setSelectionMode(ListSelectionModel.SINGLE_INTERVAL_SELECTION);

       JScrollPane scrollPane = new JScrollPane(tableClassAtt);
       scrollPane.setPreferredSize(new Dimension(400,100));

       tableClassAtt.setDragEnabled(true);
       
       // This will call the controller whenever a drag & drop occurs
       ClassificationController cc = new ClassificationController();
       cc.DragToClassAttributeTable(tableClassAtt);

       JPanel panel = new JPanel(new BorderLayout());
       panel.add(scrollPane, BorderLayout.CENTER);
       panel.setBorder(BorderFactory.createTitledBorder("Class-Attribute Table"));
       return panel;
   }
   
   /**
    * This method initializes Class-Relationship Table
    *
    * @return javax.swing.JTable
    */
   private JPanel createClassRelationshipTable() {
       DefaultTableModel model = new DefaultTableModel();
       
       model.addColumn("SourceClass");
       model.addColumn("Relationship");
       model.addColumn("DestinationClass");
       
       model.addRow(new String[]{"", "", ""});
       model.addRow(new String[]{"", "", ""});
       model.addRow(new String[]{"", "", ""});

       tableClassRel = new JTable(model);
       tableClassRel.getTableHeader().setFont(new Font("Arial", Font.ITALIC + Font.BOLD , 12));
       tableClassRel.getTableHeader().setReorderingAllowed(false);
       tableClassRel.setSelectionMode(ListSelectionModel.SINGLE_INTERVAL_SELECTION);

       JScrollPane scrollPane = new JScrollPane(tableClassRel);
       scrollPane.setPreferredSize(new Dimension(400,100));

       tableClassRel.setDragEnabled(true);
       // This will call the controller whenever a drag & drop occurs
       ClassificationController cc = new ClassificationController();
       cc.DragToClassRelationTable(tableClassRel);

       JPanel panel = new JPanel(new BorderLayout());
       panel.add(scrollPane, BorderLayout.CENTER);
       panel.setBorder(BorderFactory.createTitledBorder("Class-Relationship Table"));
       return panel;
   }
   /**
   ...
   public JTextPane getEditorTextPane() {
      if (EditorTextPane == null) {
         ...
         EditorTextPane.addMouseListener(this);
         EditorTextPane.setDragEnabled(true);
         
         ClassificationController cc = new ClassificationController();
         cc.TransferTextAreaAction(EditorTextPane);
      }
   ...
   public JList getFinalList() {
	      if (finalList == null) {
	    	  finalList=new JList(DomainModel.getInstance());
	    	  finalList.setFont(new Font("Dialog", Font.PLAIN, 15));
	    	  finalList.setDragEnabled(true);
	    	  finalList.setLayoutOrientation(JList.HORIZONTAL_WRAP);
	      }
...
public JList getDomainConceptList(DefaultListModel listModel) {
	      if (DomainConceptList == null) {
	         //DomainConceptList=new JList(DomainModel.getInstance());
	         DomainConceptList=new JList(listModel);
	         DomainConceptList.setFont(new Font("Dialog", Font.PLAIN, 15));
	      }
	      DomainConceptList.setVisible(true);
	      return DomainConceptList;
...
private JScrollPane getListScrollPane() {
   ...
   @SuppressWarnings({ "rawtypes", "unchecked" })
   private JScrollPane getFinalListPane() {
         if (FinalListPane == null) {

       	  FinalListPane=new JScrollPane();
       	FinalListPane.setVisible(true);
       	FinalListPane.setViewportView(getFinalList());
         }
         return FinalListPane;
      }
    ...
    * @return javax.swing.JButton
    */
   private JButton getUnHighlightAllButton() {
      if (unHighlightAllButton == null) {
    	  unHighlightAllButton=new JButton();
    	  unHighlightAllButton.setText("Clear Highlights");
    	  unHighlightAllButton.setEnabled(true);
    	  unHighlightAllButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent e) {
            	String text = getEditorTextPane().getText();
            	String a[] = text.split(" ");
            	for (String string : a) {
					unhighlightAllInstances(string);
					selectedMap.remove(string);
				}
            }
         });
      }
      return unHighlightAllButton;
   }
   
   /**
    * This method initializes ParseButton
    *
    * @return javax.swing.JButton
    */
   private JButton getParseButton() {
      if (ParseButton == null) {
    	  ...
    	  ParseButton.setText("Identify Text");
...
private void identifyText() throws ClassNotFoundException, IOException {
    ...
    * highlights one occurrence of a model concept
    */
   public void highlightInstance(int start, int end, Color color) {
      highlightWord(start, end, color);
   }
...
//      addAddClassAction(new AddClassAction(),0,0);
//      addAddAttributeAction(new AddAttributeAction());
//      addAddAggregationAction(new AddAggregationAction(),0,0);
//      addAddAssociationAction(new AddAssociationAction(),0,0);
//      addAddAssociationClassAction(new AddAssociationClassAction(),0,0);
...
public void mouseClicked(MouseEvent e) {
	//This method captures mouse event on words and highlights/un-highlights them
	//highlighted words enter the selection that can be dragged and dropped in the concept model tables.
	Caret caret = getEditorTextPane().getCaret();
	...
	if(temp < length)
	{
		while(temp < length && text.charAt(temp) != ' ')
		{
			temp++;
		}
		ep = temp;
	...
	try{
		selectedString = text.substring(sp, ep);
		
		if(e.getButton() == 1)
		{
			highlightInstance(sp, ep, Color.GRAY);
			selectedMap.put(selectedString, selectedString);
			
//		bot.mouseMove(x, y);
			if(mE==3)
			{
				unhighlightWord(sp, ep);
				mE=1;
				selectedMap.remove(selectedString);
			}
